...
(function(){
  const DICT = {
    en: {
      ...
      'auth.p1':'The nine levers of your growth, scored',
      'auth.p2':'Evidence reviewed by a Scale9X analyst',
      'auth.p3':'A board-ready growth diagnosis in days, not months',
    ...
    id: {
      ...
      'auth.p1':'Sembilan tuas pertumbuhan Anda, dinilai',
      'auth.p2':'Bukti ditinjau oleh analis Scale9X',
      'auth.p3':'Diagnosis pertumbuhan siap-rapat direksi dalam hitungan hari, bukan bulan',
